...
const ModifiersListPage: FC<ModifiersListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="modifiers-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="modifiers-list-title">
          ModifiersList Page
        </h1>
        
        <div data-testid="modifiers-list-content">
