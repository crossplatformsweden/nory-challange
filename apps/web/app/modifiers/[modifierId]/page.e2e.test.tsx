...
test.describe('ModifierDetailPage', () => {
  ...
  test('renders all required elements', async ({ page }) => {
    ...
    await expect(page.getByTestId('modifier-detail-title')).toBeVisible()
    await expect(page.getByTestId('modifier-detail-content')).toBeVisible()
  })
  ...
  test('takes a screenshot of the page', async ({ page, browserName }) => {
    ...
    await page.screenshot({ 
      path: `./screenshots/modifier-detail_${browserName}_${timestamp}.png`,
      fullPage: true 
    })
  })
}) 