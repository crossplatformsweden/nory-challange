...
test.describe('ModifierOptionsListPage', () => {
  ...
  test('renders all required elements', async ({ page }) => {
    ...
    await expect(page.getByTestId('modifier-options-list-title')).toBeVisible()
    await expect(page.getByTestId('modifier-options-list-content')).toBeVisible()
  })
  ...
  test('takes a screenshot of the page', async ({ page, browserName }) => {
    ...
    await page.screenshot({ 
      path: `./screenshots/modifier-options-list_${browserName}_${timestamp}.png`,
      fullPage: true 
    })
  })
}) 