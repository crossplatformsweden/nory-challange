...
test.describe('ModifierOptionDetailPage', () => {
  ...
  test('renders all required elements', async ({ page }) => {
    ...
    await expect(page.getByTestId('modifier-option-detail-title')).toBeVisible()
    await expect(page.getByTestId('modifier-option-detail-content')).toBeVisible()
  })
  ...
  test('takes a screenshot of the page', async ({ page, browserName }) => {
    ...
    await page.screenshot({ 
      path: `./screenshots/modifier-option-detail_${browserName}_${timestamp}.png`,
      fullPage: true 
    })
  })
}) 