...
const ModifierOptionDetailPage: FC<ModifierOptionDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="modifier-option-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="modifier-option-detail-title">
