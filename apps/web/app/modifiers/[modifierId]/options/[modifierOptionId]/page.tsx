...
// TODO USE THIS HOOK
import { useGetModifierOptionById } from '@nory/api-client';
 ...
 *   const { data, isLoading, error } = useGetModifierOptionById();
 * 
...
const ModifierOptionDetailPage: FC<ModifierOptionDetailPageProps> = () => {
  return (
    <div
      ...
      data-testid="modifier-option-detail-page"
    >
      <div className="card-body">
        <h1
          className="card-title text-2xl font-bold"
          data-testid="modifier-option-detail-title"
        >
          ModifierOptionDetail Page
        </h1>

        <div data-testid="modifier-option-detail-content">
