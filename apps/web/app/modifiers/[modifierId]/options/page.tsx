...
const ModifierOptionsListPage: FC<ModifierOptionsListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="modifier-options-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="modifier-options-list-title">
