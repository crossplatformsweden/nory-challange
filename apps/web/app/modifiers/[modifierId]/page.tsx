...
// TODO USE THIS HOOK
import { useGetModifierById } from '@nory/api-client';
 ...
 *   const { data, isLoading, error } = useGetModifierById();
 * 
...
const ModifierDetailPage: FC<ModifierDetailPageProps> = () => {
  return (
    <div
      ...
      data-testid="modifier-detail-page"
    >
      <div className="card-body">
        <h1
          className="card-title text-2xl font-bold"
          data-testid="modifier-detail-title"
        >
          ModifierDetail Page
        </h1>

        <div data-testid="modifier-detail-content">Add your content here</div>
      </div>
    </div>
  );
};
