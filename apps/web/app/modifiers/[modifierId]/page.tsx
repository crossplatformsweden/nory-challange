...
const ModifierDetailPage: FC<ModifierDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="modifier-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="modifier-detail-title">
          ModifierDetail Page
        </h1>
        
        <div data-testid="modifier-detail-content">
