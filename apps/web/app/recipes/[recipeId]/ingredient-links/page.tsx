...
const RecipeIngredientLinksPage: FC<RecipeIngredientLinksPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="recipe-ingredient-links-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="recipe-ingredient-links-title">
          RecipeIngredientLinks Page
        </h1>
        
        <div data-testid="recipe-ingredient-links-content">
