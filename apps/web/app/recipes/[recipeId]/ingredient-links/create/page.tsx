...
const CreateRecipeIngredientLinkPage: FC<CreateRecipeIngredientLinkPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="create-recipe-ingredient-link-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="create-recipe-ingredient-link-title">
          CreateRecipeIngredientLink Page
        </h1>
        
        <div data-testid="create-recipe-ingredient-link-content">
