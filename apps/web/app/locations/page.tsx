...
const LocationsPage: FC<LocationsPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="locations-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="locations-title">
          Locations Page
        </h1>
        
        <div data-testid="locations-content">
