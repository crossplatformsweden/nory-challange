...
const InventoryStockPage: FC<InventoryStockPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="inventory-stock-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="inventory-stock-title">
          InventoryStock Page
        </h1>
        
        <div data-testid="inventory-stock-content">
