...
interface CreateIngredientCostPageProps {}

const CreateIngredientCostPage: FC<CreateIngredientCostPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="create-ingredient-cost-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="create-ingredient-cost-title">
          CreateIngredientCost Page
        </h1>
        
        <div data-testid="create-ingredient-cost-content">
