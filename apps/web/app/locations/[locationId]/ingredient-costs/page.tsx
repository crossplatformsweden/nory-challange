...
const IngredientCostsListPage: FC<IngredientCostsListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="ingredient-costs-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="ingredient-costs-list-title">
          IngredientCostsList Page
        </h1>
        
        <div data-testid="ingredient-costs-list-content">
