...
const IngredientCostDetailPage: FC<IngredientCostDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="ingredient-cost-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="ingredient-cost-detail-title">
