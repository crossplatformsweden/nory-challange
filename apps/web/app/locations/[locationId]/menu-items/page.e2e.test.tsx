...
test.describe('MenuItemsListPage', () => {
  ...
  test('renders all required elements', async ({ page }) => {
    ...
    await expect(page.getByTestId('menu-items-list-page')).toBeVisible()
  ...
  test('takes a screenshot of the page', async ({ page, browserName }) => {
    ...
    await page.screenshot({ 
      path: `./screenshots/menu-items-list_${browserName}_${timestamp}.png`,
      fullPage: true 
    })
  })
}) 