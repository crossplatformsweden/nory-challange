...
const MenuItemsListPage: FC<MenuItemsListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="menu-items-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="menu-items-list-title">
          MenuItemsList Page
        </h1>
        
        <div data-testid="menu-items-list-content">
