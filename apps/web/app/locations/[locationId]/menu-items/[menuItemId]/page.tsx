...
const MenuItemDetailPage: FC<MenuItemDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="menu-item-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="menu-item-detail-title">
          MenuItemDetail Page
        </h1>
        
        <div data-testid="menu-item-detail-content">
