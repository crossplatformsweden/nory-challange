...
const CreateMenuItemPage: FC<CreateMenuItemPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="create-menu-item-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="create-menu-item-title">
          CreateMenuItem Page
        </h1>
        
        <div data-testid="create-menu-item-content">
