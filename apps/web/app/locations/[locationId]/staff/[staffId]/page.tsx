...
const StaffDetailPage: FC<StaffDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="staff-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="staff-detail-title">
          StaffDetail Page
        </h1>
        
        <div data-testid="staff-detail-content">
