...
const CreateStaffPage: FC<CreateStaffPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="create-staff-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="create-staff-title">
          CreateStaff Page
        </h1>
        
        <div data-testid="create-staff-content">
