...
const SalesListPage: FC<SalesListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="sales-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="sales-list-title">
          SalesList Page
        </h1>
        
        <div data-testid="sales-list-content">
