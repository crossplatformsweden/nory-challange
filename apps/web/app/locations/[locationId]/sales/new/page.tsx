...
const NewSalePage: FC<NewSalePageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="new-sale-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="new-sale-title">
          NewSale Page
        </h1>
        
        <div data-testid="new-sale-content">
