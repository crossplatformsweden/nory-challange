...
test.describe('SalesListPage', () => {
  ...
  test('renders all required elements', async ({ page }) => {
    ...
    await expect(page.getByTestId('sales-list-title')).toBeVisible()
    await expect(page.getByTestId('sales-list-content')).toBeVisible()
  })
  ...
  test('takes a screenshot of the page', async ({ page, browserName }) => {
    ...
    await page.screenshot({ 
      path: `./screenshots/sales-list_${browserName}_${timestamp}.png`,
      fullPage: true 
    })
  })
}) 