...
const SaleDetailPage: FC<SaleDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="sale-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="sale-detail-title">
          SaleDetail Page
        </h1>
        
        <div data-testid="sale-detail-content">
