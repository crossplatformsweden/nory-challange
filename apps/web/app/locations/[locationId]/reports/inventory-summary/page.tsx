...
const InventorySummaryReportPage: FC<InventorySummaryReportPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="inventory-summary-report-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="inventory-summary-report-title">
          InventorySummaryReport Page
        </h1>
        
        <div data-testid="inventory-summary-report-content">
