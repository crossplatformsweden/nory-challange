...
const InventoryMovementsTimelinePage: FC<InventoryMovementsTimelinePageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="inventory-movements-timeline-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="inventory-movements-timeline-title">
