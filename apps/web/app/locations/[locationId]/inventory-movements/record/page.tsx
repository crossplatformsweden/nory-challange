 ...
 * import { useCreateInventoryMovement } from '@repo/api-client';
 * 
 * // Create a client
 ...
 *   const { data, isLoading, error } = useCreateInventoryMovement();
 * 
...
const RecordInventoryMovementPage: FC<
  RecordInventoryMovementPageProps
> = () => {
  return (
    <div
      className="card bg-base-100 shadow-xl"
      data-testid="record-inventory-movement-page"
    >
      <div className="card-body">
        <h1
          className="card-title text-2xl font-bold"
          data-testid="record-inventory-movement-title"
        >
          RecordInventoryMovement Page
        </h1>

        <div data-testid="record-inventory-movement-content">
