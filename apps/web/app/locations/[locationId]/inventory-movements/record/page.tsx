...
const RecordInventoryMovementPage: FC<RecordInventoryMovementPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="record-inventory-movement-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="record-inventory-movement-title">
