        ...
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <p className="py-6" data-testid="home-description">
              Your comprehensive inventory management solution. Streamline your
              operations, track ingredients, manage recipes, and optimize your
        ...
        >
          <div className="card-body">
            ...
            <p data-testid="home-ingredients-description">
              Track and manage your ingredient inventory, costs, and suppliers.
            </p>
            <div className="card-actions justify-end">
              <a
                href="/ingredients"
        ...
        >
          <div className="card-body">
            ...
            <p data-testid="home-modifiers-description">
              Manage menu modifiers, options, and pricing across your locations.
            </p>
            <div className="card-actions justify-end">
              <a
                href="/modifiers"
