...
const IngredientDetailPage: FC<IngredientDetailPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="ingredient-detail-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="ingredient-detail-title">
          IngredientDetail Page
        </h1>
