...
const IngredientsListPage: FC<IngredientsListPageProps> = () => {
  return (
    <div className="card bg-base-100 shadow-xl" data-testid="ingredients-list-page">
      <div className="card-body">
        <h1 className="card-title text-2xl font-bold" data-testid="ingredients-list-title">
          IngredientsList Page
        </h1>
        
        <div data-testid="ingredients-list-content">
