...
export const listLocationMenuItems = (
  ...
  return axios.get(`/locations/${locationId}/menuItems`, options);
};
...
export const getListLocationMenuItemsQueryOptions = <
  TData = Awaited<ReturnType<typeof listLocationMenuItems>>,
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof listLocationMenuItems>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListLocationMenuItemsQueryKey(locationId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listLocationMenuItems>>
  > = ({ signal }) =>
    listLocationMenuItems(locationId, { signal, ...axiosOptions });
...
export type ListLocationMenuItemsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listLocationMenuItems>>
>;
export type ListLocationMenuItemsQueryError = AxiosError<
 ...
 * @summary List menu items for a specific location
 */
export const useListLocationMenuItems = <
  TData = Awaited<ReturnType<typeof listLocationMenuItems>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  locationId: string,
  ...
  const queryOptions = getListLocationMenuItemsQueryOptions(
    locationId,
    options
  );
...
export const getCreateLocationMenuItemMutationOptions = <
  TError = AxiosError<
    | BadRequestResponse
    | NotFoundResponse
    | ConflictResponse
...
export type CreateLocationMenuItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof createLocationMenuItem>>
>;
export type CreateLocationMenuItemMutationBody = LocationMenuItemCreate;
export type CreateLocationMenuItemMutationError = AxiosError<
  | BadRequestResponse
  | NotFoundResponse
  | ConflictResponse
  | InternalServerErrorResponse
 ...
 * @summary Add a recipe as a menu item to a location
 */
export const useCreateLocationMenuItem = <
  TError = AxiosError<
    | BadRequestResponse
    | NotFoundResponse
    | ConflictResponse
...
export const getLocationMenuItemById = (
  ...
  return axios.get(`/locations/${locationId}/menuItems/${menuItemId}`, options);
};

export const getGetLocationMenuItemByIdQueryKey = (
  locationId: string,
  menuItemId: string
) => {
...
export const getGetLocationMenuItemByIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getLocationMenuItemById>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  locationId: string,
  menuItemId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getLocationMenuItemById>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    ...
    getGetLocationMenuItemByIdQueryKey(locationId, menuItemId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getLocationMenuItemById>>
  > = ({ signal }) =>
    getLocationMenuItemById(locationId, menuItemId, {
      signal,
      ...axiosOptions,
    });
...
export type GetLocationMenuItemByIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLocationMenuItemById>>
>;
export type GetLocationMenuItemByIdQueryError = AxiosError<
  NotFoundResponse | InternalServerErrorResponse
>;
 ...
 * @summary Get a menu item by ID for a location
 */
export const useGetLocationMenuItemById = <
  TData = Awaited<ReturnType<typeof getLocationMenuItemById>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  locationId: string,
  ...
  const queryOptions = getGetLocationMenuItemByIdQueryOptions(
    locationId,
    menuItemId,
    options
  );
...
export const getUpdateLocationMenuItemMutationOptions = <
  TError = AxiosError<
...
export type UpdateLocationMenuItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateLocationMenuItem>>
>;
export type UpdateLocationMenuItemMutationBody = LocationMenuItemUpdate;
export type UpdateLocationMenuItemMutationError = AxiosError<
  BadRequestResponse | NotFoundResponse | InternalServerErrorResponse
>;
 ...
 * @summary Update a menu item for a location
 */
export const useUpdateLocationMenuItem = <
  TError = AxiosError<
    BadRequestResponse | NotFoundResponse | InternalServerErrorResponse
  >,
  TContext = unknown,
...
export const getDeleteLocationMenuItemMutationOptions = <
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteLocationMenuItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteLocationMenuItem>>
>;

export type DeleteLocationMenuItemMutationError = AxiosError<
  NotFoundResponse | InternalServerErrorResponse
>;
 ...
 * @summary Remove a menu item from a location
 */
export const useDeleteLocationMenuItem = <
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
