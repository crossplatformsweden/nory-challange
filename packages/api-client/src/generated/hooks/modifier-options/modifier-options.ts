...
export const listModifierOptions = (
  ...
  return axios.get(`/modifiers/${modifierId}/options`, options);
};
...
export const getListModifierOptionsQueryOptions = <
  TData = Awaited<ReturnType<typeof listModifierOptions>>,
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListModifierOptionsQueryKey(modifierId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listModifierOptions>>
  > = ({ signal }) =>
    listModifierOptions(modifierId, { signal, ...axiosOptions });
...
export type ListModifierOptionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listModifierOptions>>
>;
export type ListModifierOptionsQueryError = AxiosError<
 ...
 * @summary List options for a modifier group
 */
export const useListModifierOptions = <
  TData = Awaited<ReturnType<typeof listModifierOptions>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  modifierId: string,
...
export const getCreateModifierOptionMutationOptions = <
  TError = AxiosError<
...
export type CreateModifierOptionMutationResult = NonNullable<
  Awaited<ReturnType<typeof createModifierOption>>
>;
export type CreateModifierOptionMutationBody = ModifierOptionCreate;
export type CreateModifierOptionMutationError = AxiosError<
  BadRequestResponse | NotFoundResponse | InternalServerErrorResponse
>;
...
export const getGetModifierOptionByIdQueryKey = (
  modifierId: string,
  modifierOptionId: string
) => {
...
export const getGetModifierOptionByIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getModifierOptionById>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  modifierId: string,
  modifierOptionId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getModifierOptionById>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    ...
    getGetModifierOptionByIdQueryKey(modifierId, modifierOptionId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getModifierOptionById>>
  > = ({ signal }) =>
    getModifierOptionById(modifierId, modifierOptionId, {
      signal,
      ...axiosOptions,
    });
  ...
  return {
    queryKey,
    queryFn,
    enabled: !!(modifierId && modifierOptionId),
    ...queryOptions,
  } as UseQueryOptions<
    Awaited<ReturnType<typeof getModifierOptionById>>,
    TError,
...
export type GetModifierOptionByIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getModifierOptionById>>
>;
export type GetModifierOptionByIdQueryError = AxiosError<
  NotFoundResponse | InternalServerErrorResponse
>;
 ...
 * @summary Get a modifier option by ID for a group
 */
export const useGetModifierOptionById = <
  TData = Awaited<ReturnType<typeof getModifierOptionById>>,
  TError = AxiosError<NotFoundResponse | InternalServerErrorResponse>,
>(
  modifierId: string,
  ...
  const queryOptions = getGetModifierOptionByIdQueryOptions(
    modifierId,
    modifierOptionId,
    options
  );
...
export type UpdateModifierOptionMutationError = AxiosError<
  BadRequestResponse | NotFoundResponse | InternalServerErrorResponse
>;
...
export type DeleteModifierOptionMutationError = AxiosError<
  NotFoundResponse | InternalServerErrorResponse
>;
