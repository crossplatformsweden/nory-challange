...
export const listInventoryMovementsResponseItem = zod.object({
  ...
  ingredient: zod.object({
    ...
    name: zod
      .string()
      .min(1)
      .max(listInventoryMovementsResponseIngredientNameMax),
    unit: zod
      .string()
      .min(1)
      .max(listInventoryMovementsResponseIngredientUnitMax),
  }),
  unit: zod.string().min(1).max(listInventoryMovementsResponseUnitMax),
  costPerUnit: zod
    .number()
    .min(listInventoryMovementsResponseCostPerUnitMin)
    .nullable(),
});
