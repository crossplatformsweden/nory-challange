...
jest.mock('@radix-ui/react-avatar', () => {
  ...
  return {
    ...
    Fallback: React.forwardRef(({ children, ...props }, ref) => (
      <span ref={ref} {...props}>
        {children}
      </span>
    )),
...
describe('Avatar', () => {
  ...
  it('renders with image when using mocked components', () => {
    render(
      <Avatar data-testid="avatar-root">
        <AvatarImage src="https://example.com/avatar.jpg" alt="User Avatar" data-testid="avatar-img" />
        <AvatarFallback>JD</AvatarFallback>
      </Avatar>
    );
  ...
  it('applies standard classes', () => {
    render(
      <Avatar data-testid="avatar-root">
        <AvatarImage data-testid="avatar-img" src="https://example.com/avatar.jpg" alt="User" />
