...
describe("NavigationMenu", () => {
  ...
  it("renders NavigationMenuLink", () => {
    const href = "/example";
    render(
      <NavigationMenuLink href={href}>Link Text</NavigationMenuLink>
    );
  ...
  it("navigationMenuTriggerStyle returns the correct class string", () => {
    // This is a bit tricky to test directly since it's a function
    // We can indirectly test it by checking that NavigationMenuTrigger applies these styles
    render(<NavigationMenuTrigger>Menu Item</NavigationMenuTrigger>);
  ...
  it("renders a complete navigation menu structure", () => {
    ...
    expect(screen.getByTestId("navigation-menu-trigger")).toHaveTextContent("Item 1");
